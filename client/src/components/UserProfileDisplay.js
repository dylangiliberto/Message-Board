            ...
            <table><tbody><tr>
                <td>
                    <Link className="Link" to={"/user/" + comment['username']}>
                        ...
                        <img className="pfp" src={"https://api.board.dylangiliberto.com/" + comment['pfpURL']} /> : 
    ...
    return (
        <table><tbody><tr>
            <td>
                <Link className="Link" to={"/user/" + comment['username']}>
                    {comment['pfpURL'] && comment['pfpURL'] !== "" ? 
                    <img className="pfp minipfp" src={"https://api.board.dylangiliberto.com/" + comment['pfpURL']} /> : 
